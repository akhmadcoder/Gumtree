        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Title = table.Column<int>(type: "integer", maxLength: 255, nullable: false),
                    Description = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    CityId = table.Column<int>(type: "integer", nullable: false),
                    Town = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    UserId = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { 1, 1, false, "Cars" },
                    { 2, 1, false, "Motorbikes & Scooters" },
                    { 3, 1, false, "Trucks" },
                    { 4, 1, false, "Other Vehicles" },
                    { 5, 1, false, "Accessories" },
                    { 6, 2, false, "Computers & Software" },
                    { 7, 2, false, "Phones & Accessories" },
                    { 8, 2, false, "Men's Wear" },
                    { 9, 2, false, "Woman's Wear" }
                });
